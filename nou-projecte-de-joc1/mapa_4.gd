...
var initial_message_shown = false  # Para controlar que el mensaje solo aparezca una vez

func _ready():
	# Mostrar mensaje inicial
	wave_label.visible = true
	wave_label.text = "¡AGUANTA, LA TORRE DE RADIO BUSCA ALIADOS!"
	
	# Esperar 10 segundos y ocultar el mensaje
	await get_tree().create_timer(10.0).timeout
	wave_label.visible = false
	initial_message_shown = true  # Marcar como mostrado
	...
	update_wave_label()
	wave_label.visible = true  # Mostrar el mensaje normal de preparación

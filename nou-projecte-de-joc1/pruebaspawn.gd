...
# Configuración
@export var zombies_base_por_oleada: int = 6
@export var incremento_por_oleada: int = 6
@export var tiempo_entre_spawns: float = 1.0
@export var tiempo_espera_final: float = 10.0
@export var probabilidad_enemy2: float = 0.5  # 20% de chance de spawnear enemy2
